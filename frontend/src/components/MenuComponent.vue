...
<template>
  <el-menu :default-active="pageIndex" mode="horizontal" class="el-menu-demo" @select="menuSelect" :router=true
    ...
    <el-menu-item index="/search" v-if="user.identity === '用户' || user.identity === '管理员'">车票购买</el-menu-item>
    <el-menu-item index="/station" v-if="user.identity === '管理员'">车站管理</el-menu-item>
    <el-menu-item index="/route" v-if="user.identity == '管理员'">路线管理</el-menu-item>
    <el-menu-item index="/train" v-if="user.identity == '管理员'">车次管理</el-menu-item>
    <el-menu-item index="/order" v-if="user.identity === '用户' || user.identity === '管理员'">订单</el-menu-item>
