...
<template>
  ...
  <el-dialog v-model="change" title="更改车次" width="60%" draggable :close-on-click-modal="false">
    <div>请输入更改后的车次信息</div>
    <br />
    <div>
  ...
  <el-dialog v-model="add" title="添加车次" width="60%" draggable destroy-on-close :close-on-click-modal="false">
    <div>请输入新的车次信息</div>
    <br />
    <div>
