...
<template>
  ...
  <el-dialog v-model="change" title="更改路线" width="50%" draggable :close-on-click-modal="false">
    <div>请输入更改后的路线信息</div>
    <br />
    <div>
  ...
  <el-dialog v-model="add" title="添加路线" width="50%" draggable destroy-on-close :close-on-click-modal="false">
    <div>请输入新的路线信息</div>
    <br />
    <div>
