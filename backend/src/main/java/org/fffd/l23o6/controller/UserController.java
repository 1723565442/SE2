...
public class UserController {
    ...
    public CommonResponse<?> register(@Valid @RequestBody RegisterRequest request) {
        ...
        userService.register(request.getUsername(), request.getPassword(), request.getName(), request.getIdn(), request.getPhone(), request.getType(), request.getIdentity());
        return CommonResponse.success();
    }
    ...
    public CommonResponse<?> editInfo(@Valid @RequestBody EditUserInfoRequest request) {
        StpUtil.checkLogin();
        userService.editInfo(StpUtil.getLoginIdAsString(), request.getName(), request.getIdn(), request.getPhone(), request.getType(), request.getIdentity(), request.getMileagePoints(), request.getAliBalance(), request.getWechatBalance());
        return CommonResponse.success();
    }
}